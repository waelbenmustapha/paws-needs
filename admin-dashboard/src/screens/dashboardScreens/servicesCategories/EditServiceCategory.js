...
function EditServiceCategory() {
  ...
  function handleSubmitUser() {
    ...
    if (data.name.length > 0 ) {
        fneditServiceCategory(data).then(() => navigate("/dashboard/services-categories"));
    } else {
    ...
    <>
      ...
      {isLoading&&<div className="centered">
        ...
        <p className="text-xs mb-2">
          ...
          <Link to={"/dashboard/service-category-add"}>Edit Service Category</Link>
        </p>
        <p className="mb-10 font-bold text-tiny lg:text-2xl">Edit Service Category</p>
        ...
        <div className="w-full flex justify-end items-center">
          <div className="flex flex-row flex-nowrap justify-center items-center">
            ...
            >
              <span>Update Service Category</span>
            </button>
          </div>
        </div>
      </div>
